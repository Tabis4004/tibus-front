-- =============================================================================
-- Tibus 081 — Correctif définitif équipe owner (à exécuter en une fois)
-- =============================================================================
-- Erreur corrigée : "structure of query does not match function result type"
-- Cause : RETURNS TABLE déclaré en text/varchar mais RETURN QUERY sans cast explicite.
-- =============================================================================
...
DROP FUNCTION IF EXISTS public.remove_company_user_role(uuid, text, uuid);
