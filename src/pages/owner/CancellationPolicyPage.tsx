...
import CancellationPolicySettings from "./_components/CancellationPolicySettings.tsx";
...
export default function CancellationPolicyPage() {
  ...
  return (
    <div className="p-4 md:p-6 max-w-4xl mx-auto">
      <CancellationPolicySettings key={selectedCompany.id} companyId={selectedCompany.id} />
    </div>
  );
}
