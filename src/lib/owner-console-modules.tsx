...
export const OWNER_CONSOLE_MODULES: OwnerConsoleModule[] = [
  ...
  },
  {
    ...
    sectionKey: "console.section_operations",
    sectionDefault: "Exploitation",
    titleKey: "console.gare_gerant_title",
    titleDefault: "Ma gare (gérant)",
    descKey: "console.gare_gerant_desc",
    descDefault: "Équipe, commissions guichet et programmation des départs.",
    toSuffix: "/owner/gare/gerant",
    icon: MapPinIcon,
    roles: [...GARE_MANAGER_CONSOLE_ROLE_NAMES],
    tourTarget: "owner-gare-gerant",
  },
  {
    id: "gare-comptable",
    sectionKey: "console.section_operations",
    sectionDefault: "Exploitation",
    titleKey: "console.gare_comptable_title",
    titleDefault: "Comptabilité gare",
    descKey: "console.gare_comptable_desc",
    descDefault: "Valider les reversements caisse de votre gare.",
    toSuffix: "/owner/gare/comptable",
    icon: WalletIcon,
    roles: ["comptable_gare", ...GARE_MANAGER_CONSOLE_ROLE_NAMES],
    tourTarget: "owner-gare-comptable",
  },
  {
    id: "gare-controleur",
    sectionKey: "console.section_operations",
    sectionDefault: "Exploitation",
    titleKey: "console.gare_controleur_title",
    titleDefault: "Contrôle gare",
    descKey: "console.gare_controleur_desc",
    descDefault: "Scanner les billets rattachés à votre gare.",
    toSuffix: "/owner/gare/controleur",
    icon: ScanLineIcon,
    roles: ["controleur_gare"],
    tourTarget: "owner-gare-controleur",
  },
  {
    id: "controleur-compagnie",
    sectionKey: "console.section_operations",
    sectionDefault: "Exploitation",
    titleKey: "console.controleur_title",
    titleDefault: "Contrôle compagnie",
    descKey: "console.controleur_desc",
    descDefault: "Scanner les billets et suivre les départs compagnie.",
    toSuffix: "/owner/controleur",
    icon: ScanLineIcon,
    roles: ["controleur"],
    tourTarget: "owner-controleur",
  },
  {
    id: "routes",
    sectionKey: "console.section_operations",
