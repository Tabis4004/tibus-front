-- =============================================================================
-- Tibus 076 — Owner : tous les rôles équipe (vendeur, contrôleur, comptable, gestionnaire gare)
-- =============================================================================
-- PRÉREQUIS : 046_user_role_management.sql (ou 073 si déjà exécuté)
-- Idempotent : peut être rejoué même si 073 a partiellement mis à jour les fonctions.
-- =============================================================================

-- Rôle gestionnaire gare (si 073 pas encore exécuté)
INSERT INTO "Role" ("name", "scope", "level", "isSystem", "description", "droits") VALUES
  ('gestionnaire_gare', 'company', 22, true, 'Gestionnaire de gare — part sur ventes au départ', ARRAY[
